...
window.GameModules.equipData = (() => {
  ...
  const UNIQUES = [
    ...
    ['unique-plague-bell','暗金·瘟疫铃','weapon','scytheMaiden',{dotDmg:.45,cooldown:.12,attrDmg:{shadow:.32},eliteDmgReduce:.15,crit:.10},{},'疫病加速：幽魂刃舞对DoT目标暴击伤害[x]55%，击杀精英加速DoT跳字100%'],
    ...
    ['unique-elite-boots','暗金·精英猎手长靴','boots',null,{move:.20,armor:.12,crit:.08,slowResist:.40,bossDmgReduce:.10},{},'猎手增幅：全伤害随秘境进度提高，每10%进度获得[x]8%独立乘区，最高[x]80%'],
