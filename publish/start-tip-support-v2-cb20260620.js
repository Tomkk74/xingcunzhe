...
window.GameModules.startTipTypewriter = (() => {
  ...
  function ensureSupportModal() {
    ...
    modal.innerHTML = `<div class="panel supportPanel"><h1 class="title">反馈与支持</h1><p class="sub">遇到 Bug、存档异常、卡顿或有玩法建议，欢迎私聊作者。喜欢的话也请点赞收藏支持更新。</p><div class="supportActions"><a data-support-link="chat" href="#">私聊作者<small>反馈问题时建议带上设备、职业、层数和截图描述。</small></a><a data-support-link="user" href="#">查看作者主页<small>关注作者，方便后续反馈和查看新内容。</small></a><a data-support-link="game" href="#">前往游戏主页<small>可以点赞、收藏、评论，支持持续更新。</small></a></div><p class="sub"><button id="supportClose" class="ghostBtn" type="button">关闭</button></p></div>`;
    ...
    modal.addEventListener('click', e => {
      ...
      if (!a) return;
      e.preventDefault();
      openUrl(LINKS[a.dataset.supportLink]);
    });
  }
