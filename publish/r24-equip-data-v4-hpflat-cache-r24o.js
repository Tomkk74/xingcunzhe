...
window.GameModules.equipData = (() => {
  ...
  const SET_BONUS = {
    ...
    'silver-barrage':{n:'银星弹幕',s:'3件 攻速+12% 暴击+8%；6件 [x]速射伤害+450%，速射额外连射并对精英/Boss叠加银星标记。',b3:{atkSpeed:.12,crit:.08},b6:{skill:'quickShot',skillDmg:4.5,special:'silverBarrage'}},
    'ricochet-gambit':{n:'跳弹赌局',s:'3件 暴击伤害+30% 移速+10%；6件 [x]跳弹伤害+450%，弹射次数提高并优先寻找精英目标。',b3:{critDmg:.30,move:.10},b6:{skill:'ricochetBullet',skillDmg:4.5,special:'ricochetGambit'}},
    'scorched-powder':{n:'焦土火药',s:'3件 冷却+12% 火焰伤害+18%；6件 [x]燃烧弹伤害+450%，火场持续更久，霰弹翻滚额外引爆小范围火花。',b3:{cooldown:.12,fire:.18},b6:{skill:'fireBomb',skillDmg:4.5,special:'scorchedPowder'}},
  };
